/*! rmccUIkit 3.24.2 | https://www.getuikit.com | (c) 2014 - 2025 YOOtheme | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('uikit', factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rmccUIkit = factory());
    ...
    function globalApi(App) {
      ...
      App.extend = function(options) {
        options || (options = {});
        const Super = this;
        const Sub = function rmccUIkitComponent(options2) {
    ...
    var LightboxPanel = {
      ...
      data: () => ({
        ...
        clsFit: "rmcc-lightbox-items-fit",
        clsZoom: "rmcc-lightbox-zoom",
        attrItem: "rmcc-lightbox-item",
        selList: ".rmcc-lightbox-items",
        selClose: ".rmcc-close-large",
        selNav: ".rmcc-lightbox-thumbnav, .rmcc-lightbox-dotnav",
        selCaption: ".rmcc-lightbox-caption",
        selCounter: ".rmcc-lightbox-counter",
        pauseOnHover: false,
        velocity: 2,
        Animations,
        template: `<div class="rmcc-lightbox rmcc-overflow-hidden"> <div class="rmcc-lightbox-items"></div> <div class="rmcc-position-top-right rmcc-position-small rmcc-transition-fade" rmcc-inverse> <button class="rmcc-lightbox-close rmcc-close-large" type="button" rmcc-close></button> </div> <div class="rmcc-lightbox-slidenav rmcc-position-center-left rmcc-position-medium rmcc-transition-fade" rmcc-inverse> <a href rmcc-slidenav-previous rmcc-lightbox-item="previous"></a> </div> <div class="rmcc-lightbox-slidenav rmcc-position-center-right rmcc-position-medium rmcc-transition-fade" rmcc-inverse> <a href rmcc-slidenav-next rmcc-lightbox-item="next"></a> </div> <div class="rmcc-position-center-right rmcc-position-medium rmcc-transition-fade" rmcc-inverse style="max-height: 90vh; overflow: auto;"> <ul class="rmcc-lightbox-thumbnav rmcc-lightbox-thumbnav-vertical rmcc-thumbnav rmcc-thumbnav-vertical"></ul> <ul class="rmcc-lightbox-dotnav rmcc-dotnav rmcc-dotnav-vertical"></ul> </div> <div class="rmcc-lightbox-counter rmcc-text-large rmcc-position-top-left rmcc-position-small rmcc-transition-fade" rmcc-inverse></div> <div class="rmcc-lightbox-caption rmcc-position-bottom rmcc-text-center rmcc-transition-slide-bottom rmcc-transition-opaque"></div> </div>`
      }),
      created() {
        ...
        remove$1($$(this.selNav, $el).filter((el) => !matches(el, `.rmcc-${navType}`)));
        for (const [i, item] of this.items.entries()) {
          append(list, "<div>");
          if (navType === "thumbnav") {
            wrapAll(
              toThumbnavItem(item, this.videoAutoplay),
              append($(this.selNav, $el), `<li rmcc-lightbox-item="${i}"><a href></a></li>`)
            );
          }
        }
        if (!this.slidenav) {
          remove$1($$(".rmcc-lightbox-slidenav", $el));
        }
        if (!this.counter) {
      ...
      events: [
        ...
        },
        {
          ...
          async handler(_, item) {
            ...
            this.setItem(item, "<span rmcc-spinner rmcc-inverse></span>");
            if (!src) {
              return;
            }
            let matches2;
            const iframeAttrs = {
              ...
              "rmcc-responsive": "",
              "rmcc-video": Boolean(this.videoAutoplay)
            };
      ...
      methods: {
        ...
        setError(item) {
          this.setItem(item, '<span rmcc-icon="icon: bolt; ratio: 2" rmcc-inverse></span>');
        },
        showControls() {
    ...
    function toThumbnavItem(item, videoAutoplay) {
      const el = item.poster || item.thumb && (item.type === "image" || isImage(item.thumb)) ? createEl("img", { src: item.poster || item.thumb, alt: "" }) : item.thumb && (item.type === "video" || isVideo(item.thumb)) ? createEl("video", {
        ...
        playsinline: "",
        muted: "",
        "rmcc-video": videoAutoplay === "inline"
      }) : createEl("canvas");
      if (item.thumbRatio) {
    ...
    const selDisabled$1 = ".rmcc-disabled *, .rmcc-disabled, [disabled]";
    var lightbox = {
      install: install$3,
      props: { toggle: String },
      data: { toggle: "a" },
    ...
    function install$3(rmccUIkit, Lightbox) {
      if (!rmccUIkit.lightboxPanel) {
        rmccUIkit.component("lightboxPanel", LightboxPanel);
      }
      assign(Lightbox.props, rmccUIkit.component("lightboxPanel").options.props);
    }
    ...
    function install$2(rmccUIkit) {
      rmccUIkit.notification.closeAll = function(group, immediate) {
        apply(document.body, (el) => {
          const notification = rmccUIkit.getComponent(el, "notification");
    ...
    var navbarToggleIcon = "<svg width=\"20\" height=\"20\" viewBox=\"0 0 20 20\"><style>.rmcc-navbar-toggle-icon svg&gt;[class*=&quot;line-&quot;]{transition:0.2s ease-in-out;transition-property:transform, opacity;transform-origin:center;opacity:1}.rmcc-navbar-toggle-icon svg&gt;.line-3{opacity:0}[aria-expanded=&quot;true&quot;].rmcc-navbar-toggle-icon svg&gt;.line-3,[aria-expanded=&quot;true&quot;]&gt;.rmcc-navbar-toggle-icon svg&gt;.line-3{opacity:1}[aria-expanded=&quot;true&quot;].rmcc-navbar-toggle-icon svg&gt;.line-2,[aria-expanded=&quot;true&quot;]&gt;.rmcc-navbar-toggle-icon svg&gt;.line-2{transform:rotate(45deg)}[aria-expanded=&quot;true&quot;].rmcc-navbar-toggle-icon svg&gt;.line-3,[aria-expanded=&quot;true&quot;]&gt;.rmcc-navbar-toggle-icon svg&gt;.line-3{transform:rotate(-45deg)}[aria-expanded=&quot;true&quot;].rmcc-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;]&gt;.rmcc-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;].rmcc-navbar-toggle-icon svg&gt;.line-4,[aria-expanded=&quot;true&quot;]&gt;.rmcc-navbar-toggle-icon svg&gt;.line-4{opacity:0}[aria-expanded=&quot;true&quot;].rmcc-navbar-toggle-icon svg&gt;.line-1,[aria-expanded=&quot;true&quot;]&gt;.rmcc-navbar-toggle-icon svg&gt;.line-1{transform:translateY(6px) scaleX(0)}[aria-expanded=&quot;true&quot;].rmcc-navbar-toggle-icon svg&gt;.line-4,[aria-expanded=&quot;true&quot;]&gt;.rmcc-navbar-toggle-icon svg&gt;.line-4{transform:translateY(-6px) scaleX(0)}</style><rect width=\"20\" height=\"2\" y=\"3\" class=\"line-1\"/><rect width=\"20\" height=\"2\" y=\"9\" class=\"line-2\"/><rect width=\"20\" height=\"2\" y=\"9\" class=\"line-3\"/><rect width=\"20\" height=\"2\" y=\"15\" class=\"line-4\"/></svg>";
    ...
    const parsed = {};
    function install$1(rmccUIkit) {
      rmccUIkit.icon.add = (name, svg) => {
        const added = isString(name) ? { [name]: svg } : name;
        each(added, (svg2, name2) => {
          icons[name2] = svg2;
          delete parsed[name2];
        });
        if (rmccUIkit._initialized) {
          apply(
            document.body,
            (el) => each(rmccUIkit.getComponents(el), (cmp) => {
    ...
    function install({ modal }) {
      ...
      modal.alert = function(message, options) {
        return openDialog(
          ({ i18n }) => `<div class="rmcc-modal-body">${isString(message) ? message : html(message)}</div> <div class="rmcc-modal-footer rmcc-text-right"> <button class="rmcc-button rmcc-button-primary rmcc-modal-close" type="button" autofocus>${i18n.ok}</button> </div>`,
          options
        );
      };
        ...
        write({ overflow }) {
          for (let i = 0; i < 2; i++) {
            ...
            if (!overflow[i - 1]) {
              ...
              css(this.$el, {
                "--rmcc-overflow-fade-start-opacity": toValue(percent),
                "--rmcc-overflow-fade-end-opacity": toValue(1 - percent)
              });
            }
          }
        },
